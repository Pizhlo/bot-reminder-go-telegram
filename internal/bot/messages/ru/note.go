...
const UserDoesntHaveNotesMessage = "У тебя пока нет заметок. Чтобы создать, просто пришли мне текст, и я сохраню это!"
...
const EditNoteSuccessMessage = "Заметка под номером <b>%d</b> успешно обновлена!🥳"
