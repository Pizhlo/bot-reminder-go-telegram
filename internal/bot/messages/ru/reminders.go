...
const DaysDurationMessage = "Ага, записываю...\n<b>Название:</b> %s\n<b>Тип:</b> %s\n\nТеперь напиши количество дней от 1 до 31, как часто присылать уведомления"
...
const InvalidDaysMessage = "🙅‍♂️Ты ввел неверное значение. Количество дней должно быть целым числом от 1 до 31"
