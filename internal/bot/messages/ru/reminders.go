...
const InvalidMinutesMessage = "Ты ввел неверное значение. Количество минут должно быть от целым числом 1 до 59"
const InvalidHoursMessage = "Ты ввел неверное значение. Количество часов должно быть целым числом от 1 до 24"
